      ...
      <div className={styles.contact}>
        <div className={styles.contacts}>
          ...
          <div className={styles.contactInfo}>
            <strong className={styles.strong}>Adress</strong>
        ...
        <div className={styles.contacts}>
          ...
          <div className={styles.contactInfo}>
            <strong className={styles.strong}>Call Us Now</strong>
            <p>+374 93 13 25 85</p>
            <p>+7 965 444-45-11</p>
          </div>
        </div>
        ...
        <div className={styles.contacts}>
          ...
          <div className={styles.contactInfo}>
            <strong className={styles.strong}>Mail Us Now</strong>
        ...
        <div className={styles.formData}>
          <div className={styles.header}>
            ...
            <p className={styles.headerText}>
              Have Any Query? Please <br /> Contact Us!
            </p>
          </div>
